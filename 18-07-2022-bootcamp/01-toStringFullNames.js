...
const employees = [
  ...
  //version 1
  function allEmployeesNames (employees) {
      let fullNames = []
      for (let employeeData of employees) {
          fullNames.push(`${employeeData.firstName}  ${employeeData.lastName}`);
      }
       fullNames = fullNames.toString();
      return fullNames;
  }
  ...
  function allEmployeesNames (employees) {
    let fullNames = employees.map(function(employeeData) {
