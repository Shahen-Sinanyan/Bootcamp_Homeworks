const employees = [
  ...
  function getAllEmails (employees) {
      let strOfEmail = employees.reduce(function(acc, item1) {
          return  acc + item1.email + '//'
      }, '');
      strOfEmail = strOfEmail.slice(0,strOfEmail.length-2);
      return strOfEmail;
  };
    
  getAllEmails (employees);