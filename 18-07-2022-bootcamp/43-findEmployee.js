...
function findEmployee (employees, employeeData) {
let result = employees.find(item => //aroow fn i depqum e ashxatum miayn
       item.firstName === employeeData.firstName && item.lastName === employeeData.lastName);
    return result;
   
};
findEmployee( employees, {firstName: `Roxine`, lastName: `Bedo`});